...
function do_obj_keys_done()
  ...
  local jtable_s = ""
  local hip,port,apn = "192.168.110.70","6502","TNSICOMAU2"
  jtable_s = "{TYPE:DATA,NAME:CONFIG,GROUP:WBC,VERSION:1,HIP0:"..hip..",PORT0:"..port..",APN:"..apn..",MANUALENTRY:YES,HOSTSETTLE:YES,AUTOSETTLE:NO,MSG_ENC:2}" 
